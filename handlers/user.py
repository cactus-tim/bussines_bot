...
msgconf = """
❗️Количество регистраций на встречу 4 декабря превысило число посадочных мест в зале, поэтому нам очень важно понимать, сколько человек действительно придет на мероприятие. 
